...
public class MqttClient implements IMqttClient { //), DestinationProvider {
	...
	public void subscribe(String[] topicFilters, int[] qos) throws MqttException {
		this.subscribe(topicFilters, qos, null, null);
	}
	
	public void subscribe(String topicFilter, int qos,IMqttActionListener callback) throws MqttException {
		this.subscribe(new String[] {topicFilter}, new int[] {qos}, null, callback);
	}
	
	public void subscribe(String topicFilter, int qos, Object userContext, IMqttActionListener callback) throws MqttException {
		this.subscribe(new String[] {topicFilter}, new int[] {qos}, userContext, callback);
	}
	
	public void subscribe(String[] topicFilters, int[] qos, Object userContext, IMqttActionListener callback) throws MqttException {
		IMqttToken tok = aClient.subscribe(topicFilters, qos, userContext, callback);
		tok.waitForCompletion(getTimeToWait());
