...
public class RocketmqPlugin extends ResourcePlugin<RocketmqResourceBuilder, RocketmqResource>{
	...
	public static MQPushConsumer usePushConsumer(String consumerGroup, String topic, String tag, MessageListener messageListener, 
		...
		return use().usePushConsumer(consumerGroup, topic, tag, messageListener, fromWhere, batchMaxSize, model);
	}
	...
	public static SendResult send(String producerGroup, String topic, String tags, String keys, byte[] data) {
		return use().send(producerGroup, topic, tags, keys, data);
	}

	public static SendResult sendTimeout(String producerGroup, String topic, String tags, String keys, byte[] data, int timeout) {
		return use().sendTimeout(producerGroup, topic, tags, keys, data, timeout);
	}
